            ...
            <div class="container-fluid">
                ...
                <div class="card-body table-responsive">
                    ...
                    <tbody>
                        ...
                        $statusText = $studio['is_available'] ? 'Aktif' : 'Tidak Aktif';
                        ...
                        echo "<td>
                            ...
                            <a href='../studioScheduleTables/addStudioSchedule.php?studio_id={$studio['id']}' class='btn btn-sm btn-primary'><i class='bi bi-calendar-event-fill'></i> <i class='bi bi-plus-lg'></i></a>
                        </td>";
                        echo "</tr>";
                        $no++;
                        }

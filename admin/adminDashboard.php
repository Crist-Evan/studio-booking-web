<?php
  ...
  $query = "SELECT COUNT(id) AS total FROM bookings WHERE status = 'pending'";
  ...
  $query = "SELECT COUNT(id) AS total FROM studios WHERE is_available = 1";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);
  $studiocount = $row['total'];
?>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">Start managing your data!</div>
                  <!-- /.card-body -->
            ...
            <div class="row mt-3">
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-primary">
                  ...
                  <a
                    href="bookingTables/manageBookings.php"
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-success">
                  <div class="inner">
                    <h3><?= $formatted_paymentcount ?> <sup class="fs-5">IDR</sup></h3>
                    <p>Total Income</p>
                  </div>
                  <svg
                    class="small-box-icon"
                  ...
                  <a
                    href="paymentTables/managePayments.php"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    More info <i class="bi bi-link-45deg"></i>
                  </a>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-warning">
                  ...
                  <a
                    href="userTables/manageUsers.php"
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-danger">
                  ...
                  <a
                    href="studioTables/manageStudios.php"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    More info <i class="bi bi-link-45deg"></i>
                  </a>

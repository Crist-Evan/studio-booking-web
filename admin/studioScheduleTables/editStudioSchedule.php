    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        <div class="app-content-header">
            ...
            <h3 class="mb-0">Edit Jadwal Studio</h3>
        ...
        <div class="app-content">
            ...
            <div class="card card-primary card-outline">
                ...
                <form method="POST">
                    ...
                    <input type="time" name="open_time" id="open_time" class="form-control" value="<?= htmlspecialchars($studioSchedule['open_time']) ?>" required>
                    </div>

                    <div class="mb-3">
                    <label for="close_time" class="form-label">Jam Tutup</label>
                    <input type="time" name="close_time" id="close_time" class="form-control" value="<?= htmlspecialchars($studioSchedule['close_time']) ?>" required>
                    </div>

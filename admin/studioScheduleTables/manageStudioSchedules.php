  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
            ...
            <div class="container-fluid">
                <h3 class="mb-0">Kelola Jadwal Studio</h3>
            </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">Daftar Jadwal Studio</h3>
                    <a href="../studioTables/manageStudios.php" class="btn btn-light text-primary ms-auto">
                    Tambah Jadwal di Studio Management
                    </a>
                </div>
                <div class="card-body table-responsive">
                    ...
                    <tbody>
                        ...
                        echo "<td>" . htmlspecialchars($schedule['day_of_week']) . "</td>";
                        echo "<td>" . htmlspecialchars($schedule['open_time']) . "</td>";
                        echo "<td>" . htmlspecialchars($schedule['close_time']) . "</td>";
                        echo "<td>
                            <a href='editStudioSchedule.php?studio_schedule_id={$schedule['id']}' class='btn btn-sm btn-warning'><i class='bi bi-pencil'></i></a>
                            <a href='deleteStudioSchedule.php?studio_schedule_id={$schedule['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Hapus jadwal ini?\")'><i class='bi bi-trash'></i></a>
                        </td>";
                        echo "</tr>";
                        $no++;
                        }

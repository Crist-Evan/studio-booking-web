        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../userTables/manageUsers.php" class="nav-link active">
                ...
                <table class="table table-bordered table-hover align-middle">
                  ...
                  <tbody>
                    ...
                    while ($user = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<td>" . htmlspecialchars($user['number_phone']) . "</td>";
                      echo "<td>" . htmlspecialchars($user['role']) . "</td>";
                      echo "<td>
                        <a href='editUser.php?user_id={$user['id']}' class='btn btn-sm btn-warning'><i class='bi bi-pencil'></i></a>
                        <a href='deleteUser.php?user_id={$user['id']}' class='btn btn-sm btn-danger' onclick='return confirm(\"Hapus user ini?\")'><i class='bi bi-trash'></i></a>
                      </td>";
                      echo "</tr>";
                      $no++;
                    }

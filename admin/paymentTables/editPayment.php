<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($newStatus == 'paid') {
            $query = "UPDATE bookings SET status = 'confirmed' WHERE id = " . $payment['booking_id'];
            $result = mysqli_query($conn, $query);
        } elseif($newStatus == 'failed') {
            $query = "UPDATE bookings SET status = 'cancelled' WHERE id = " . $payment['booking_id'];
            $result = mysqli_query($conn, $query);
        }
    ...
    <div class="app-wrapper">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../paymentTables/managePayments.php" class="nav-link active">
      ...
      <main class="app-main">
        <div class="app-content-header">
            ...
            <a href="managePayments.php" class="btn btn-secondary">
        ...
        <div class="app-content">
            ...
            <div class="card card-primary card-outline">
                ...
                <form method="POST">
                    ...
                    <input type="text" class="form-control" name="method" id="method" value="<?= $payment['method'] ?>" required>
                    </div>

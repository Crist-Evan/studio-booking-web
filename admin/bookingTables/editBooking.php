    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        <div class="app-content-header">
            ...
            <a href="manageBookings.php" class="btn btn-secondary">
        ...
        <div class="app-content">
            ...
            <div class="card card-primary card-outline">
                ...
                <form action="updateBooking.php" method="POST">
                    ...
                    <input type="date" class="form-control" name="booking_date" id="booking_date" value="<?= $booking['booking_date'] ?>" required>
                    </div>

                    <div class="mb-3">
                    <label for="start_time" class="form-label">Waktu Mulai</label>
                    <input type="time" class="form-control" name="start_time" id="start_time" value="<?= $booking['start_time'] ?>" required>
                    </div>

                    <div class="mb-3">
                    <label for="end_time" class="form-label">Waktu Selesai</label>
                    <input type="time" class="form-control" name="end_time" id="end_time" value="<?= $booking['end_time'] ?>" required>
                    </div>
